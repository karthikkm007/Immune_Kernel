...
##### Edited for adaptation by Keertesh
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@#

### This script is to compile Immune™ kernel for Nougat ROMs

### This is INLINE_KERNEL_COMPILATION

####
## platform specifics
export KBUILD_BUILD_USER="Keertesh"
export KBUILD_BUILD_HOST="Immne_Machine"
export ARCH=arm
export SUBARCH=arm
...
KERNEL_DIR=$PWD
KERNEL_TOOLCHAIN=$KERNEL_DIR/android-prebuilts-gcc-linux-x86-arm-arm-eabi-4.9/bin/$TOOL_CHAIN_ARM
...
ZIP=Immune™-$z-wt88047-$DATE.zip;

#dtb tool

./Immune/dtbToolCM -2 -o ./arch/arm/boot/dt.img -s 2048 -p ./scripts/dtc/ ./arch/arm/boot/dts/
